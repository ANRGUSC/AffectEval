...
class FeatureExtractorClient():
    # TODO: change signature to specify feature types as a dictionary of {signal: [feature 1, feature 2]}
    def __init__(self, signal_types, source_folder=None, host="localhost", port=1883, subscribe_topic="/feature_extractor", publish_topic="/feature_selector", client_id="Feature Extractor", keepalive=60):
    ...
    def connect(self):
        ...
        print(f"Feature Extractor node (ID: {self.client_id}) connected to host")
